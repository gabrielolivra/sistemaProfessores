...
<head>
    ...
    <link rel="stylesheet" href="../../assets/css/editar_mensagem.css">
...
<header>
    ...
    <?php 
    $id = $_GET['id'];
    $sql = "SELECT  m.nomeAluno, m.mensagem, m.dtEnvio, m.id,
    CASE 
    WHEN m.status = 0 THEN 'Pendente'
    WHEN m.status = 1 THEN 'Respondido'
    ELSE m.status
    END AS status_descricao
    FROM mensagens m  WHERE  m.id = $id order by m.dtEnvio desc ";
    ...
    ?>
    <form action="../../assets/php/editar_mensagem_admin.php" method="post">
